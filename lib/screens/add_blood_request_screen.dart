...
class _AddBloodRequestScreenState extends State<AddBloodRequestScreen> {
  ...
  Widget _requestDatePicker() => GestureDetector(
        ...
        child: AbsorbPointer(
          child: TextFormField(
            key: ValueKey<DateTime?>(_requestDate), // Changed to nullable DateTime
            // Fix: Handle null case for initialValue
            initialValue: _requestDate != null ? Tools.formatDate(_requestDate!) : '',
            validator: (_) =>
